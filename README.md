...
Telegram Mini App на реальных данных (вход через подпись Telegram `initData`):

| Статистика | Подключение ящика |
|---|---|
| <img src="docs/screenshots/mini-stats.png" width="300" alt="Дашборд: ящики, письма, разбивка по важности, стоимость"> | <img src="docs/screenshots/mini-accounts.png" width="300" alt="Форма подключения почтового ящика"> |

Дашборд показывает число ящиков и писем, разбивку по важности (🔴 срочно · 🟡 важно · ⚪️ к сведению · шум) и суммарную стоимость LLM-вызовов. Презентация защиты — [docs/MailPulse.pptx](docs/MailPulse.pptx).
